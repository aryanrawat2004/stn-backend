...
alter table public.sn_jobs
  ...
  add column if not exists "recruiterName" text,
  add column if not exists "recruiterDesignation" text,
  add column if not exists "recruiterEmail" text,
  add column if not exists "recruiterPhone" text,
